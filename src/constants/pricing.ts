/** Listed price for one Turnitin submission (USD), shown in welcome/help. */
export const TURNITIN_SUBMISSION_USD = 36
...
export const CREDIT_HKD_PER_CREDIT = 30
...
export function pricingI18nPlaceholders(): Record<string, string> {
  return {
    turnitinUsd: String(TURNITIN_SUBMISSION_USD),
    ...
    creditExampleHkd: String(calculateCreditPrice(CREDIT_PURCHASE_EXAMPLE_CREDITS)),
  }
}
